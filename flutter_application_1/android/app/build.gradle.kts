plugins {
    ...
    // kotlin-android is NOT listed here because android.builtInKotlin=true in gradle.properties
    // already activates Kotlin support via Flutter's built-in mechanism.
